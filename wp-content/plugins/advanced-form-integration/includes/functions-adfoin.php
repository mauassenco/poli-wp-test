...
function adfoin_get_form_providers()
{
    ...
    $pro_items = array(
        ...
        'elementorpro2'   => __( 'Elementor Pro Form (Manual Method)', 'advanced-form-integration' ),
...
function adfoin_get_form_providers_html()
{
    ...
    $ex_list = array( 'cf7', 'woocommerce', 'amelia' );
    $providers_html = '';
...
function adfoin_get_special_tags( $cat = '' )
{
    ...
    if ( '1' != get_option( 'adfoin_general_settings_st' ) ) {
        ...
        $special_tags['_user_first_name'] = __( '_User_First_Name', 'advanced-form-integration' );
        $special_tags['_user_last_name'] = __( '_User_Last_Name', 'advanced-form-integration' );
        $special_tags['_user_display_name'] = __( '_User_Display_Name', 'advanced-form-integration' );
        $special_tags['_user_email'] = __( '_User_Email', 'advanced-form-integration' );
    }
